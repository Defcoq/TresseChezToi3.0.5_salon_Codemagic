...
import '../modules/salons/views/salons_options_form_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.SALON, page: () => SalonView(), binding: SalonsBinding(), transition: Transition.downToUp),
    GetPage(name: Routes.SALON_FORM, page: () => SalonFormView(), binding: SalonsBinding()),
    GetPage(name: Routes.SALON_OPTIONS_FORM, page: () => SalonsOptionsFormView(), binding: SalonsBinding()),
    GetPage(name: Routes.SALONS, page: () => SalonsView(), binding: SalonsBinding()),
