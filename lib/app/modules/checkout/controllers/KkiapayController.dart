...
class KkiapayController extends GetxController {
  ...
  void getUrl() {
    url.value = _paymentRepository.getKkiapayUrl(eProviderSubscription.value);
    print(url.value);
  }

  void showConfirmationIfSuccess() {
    final _doneUrl = "${Helper.toUrl(Get.find<GlobalService>().baseUrl)}subscription/payments/kkiapay";
    if (url == _doneUrl) {
